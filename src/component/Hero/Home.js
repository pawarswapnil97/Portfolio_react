        ...
        <div className='container f_flex top'>
          <div className='top text-center w-100'>
            <h1 className="text-white">
              Hi, I’m <span>Pawar Swapnil</span>
            </h1>
            <h2>
              a
              <span>
                <Typewriter  words={[" React Js Developer.", " Full Stack Developer."," Computer Science Student."]} loop cursor cursorStyle='|' typeSpeed={70} deleteSpeed={50} delaySpeed={1000} />
              </span>
            </h2>
            ...
            <h4 className="text-white">FIND  ME</h4>
                <div className='button mt-5'>
                  <button className='btn-sh mr-4 mb-5 bg-primary'>
                   <a href="https://www.linkedin.com/in/swapnil-pawar-180a6b22b"> <i class='fa fa-linkedin text-white'></i></a>
                  </button>
                  <button className='btn-sh mr-4 bg-dark'>
                    <a href="https://github.com/pawarswapnil97"><i class='fa fa-github text-white'></i></a>
                  </button>
                  <button className='btn-sh mr-4 bg-success'>
                    <a  href="https://wa.me/919766273575/?text=Hii, Whatsup !" target="_blank" class="google-plus">
                    <i class='fa fa-whatsapp text-white'></i> </a>
                  </button>
                  <button className='btn-sh mr-4 mb-5 insta_icon'>
                   <a href="https://www.instagram.com/swapnil_010_"> <i class='fa fa-instagram'></i></a>
                  </button>
                </div>
